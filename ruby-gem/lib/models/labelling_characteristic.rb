...
module DfcLinkmlConnector
  module Models
    class LabellingCharacteristic < Core::SemanticObject
      ...
      # @param labellingCharacteristicOf: nil, date: nil, description: nil, name: nil, characteristicOf: nil, dimension: nil, labellingDimension: nil
      def initialize(semanticId, labellingCharacteristicOf: nil, date: nil, description: nil, name: nil, characteristicOf: nil, dimension: nil, labellingDimension: nil)
        super(semanticId)
