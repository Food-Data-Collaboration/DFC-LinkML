...
module DfcLinkmlConnector
  module Models
    class OrderLine < Core::SemanticObject
      ...
      # @param discount: nil, quantity: nil, concerns: nil, price: nil, isFulfilledBy: nil, date: nil, description: nil, name: nil, characteristicOf: nil, dimension: nil, hasQuantity: nil, partOf: nil
      def initialize(semanticId, discount: nil, quantity: nil, concerns: nil, price: nil, isFulfilledBy: nil, date: nil, description: nil, name: nil, characteristicOf: nil, dimension: nil, hasQuantity: nil, partOf: nil)
        super(semanticId)
        @discount = discount
        @quantity = quantity
        @concerns = concerns
