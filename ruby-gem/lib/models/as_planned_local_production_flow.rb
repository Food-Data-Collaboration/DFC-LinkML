  ...
  module Models
    class AsPlannedLocalProductionFlow < ProductionFlow
      ...
      def initialize(semanticId, quantity: nil, outputOf: nil, produces: nil, date: nil, description: nil, name: nil, characteristicOf: nil, dimension: nil, hasQuantity: nil)
        super(semanticId, quantity: quantity, outputOf: outputOf, produces: produces, date: date, description: description, name: name, characteristicOf: characteristicOf, dimension: dimension, hasQuantity: hasQuantity)
