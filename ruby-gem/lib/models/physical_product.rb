...
module DfcLinkmlConnector
  module Models
    class PhysicalProduct < WhatSubject
      ...
      # @return [Array<LocalizedProduct, String>]
      ...
      # @param date: nil, description: nil, name: nil, characteristicOf: nil, dimension: nil, image: nil, quantity: nil, concernedBy: nil, constituedBy: nil, consumedBy: nil, fulfills: nil, producedBy: nil, hasQuantity: nil, ownedBy: nil, represents: [], tracedBy: nil
      def initialize(semanticId, date: nil, description: nil, name: nil, characteristicOf: nil, dimension: nil, image: nil, quantity: nil, concernedBy: nil, constituedBy: nil, consumedBy: nil, fulfills: nil, producedBy: nil, hasQuantity: nil, ownedBy: nil, represents: [], tracedBy: nil)
